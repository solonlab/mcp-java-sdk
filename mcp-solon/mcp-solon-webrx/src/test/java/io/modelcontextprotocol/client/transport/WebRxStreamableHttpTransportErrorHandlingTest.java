 ...
 */
@Timeout(15)
public class WebRxStreamableHttpTransportErrorHandlingTest {
	...
	void startServer() throws IOException {
		...
		transport = WebRxStreamableHttpTransport.builder(new HttpUtilsBuilder().baseUri(HOST)).build();
	}
	...
	void testReconnectErrorHandling() throws InterruptedException {
		...
		var transport = WebRxStreamableHttpTransport.builder(new HttpUtilsBuilder().baseUri(HOST))
			.endpoint("/mcp-sse")
