...
@Timeout(15)
class WebRxSseIntegrationTests extends AbstractMcpClientServerIntegrationTests {
	...
	protected void prepareClients(int port, String mcpEndpoint) {
		...
		clientBuilders.put("webflux",
				McpClient
						.sync(WebRxSseClientTransport.builder(new HttpUtilsBuilder().baseUri("http://localhost:" + PORT))
								.sseEndpoint(CUSTOM_SSE_ENDPOINT)
								.build())
